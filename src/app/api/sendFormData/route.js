...
export async function POST(request) {
  ...
  // console.log(`API sendFormData RETURNING firstname: ${firstname}, lastname: ${lastname}, email: ${email}, message: ${message}, and phone: ${phone}`)

  try {
    console.log('log from sendFormData api route try scope - Form Data:', { firstname, lastname, email, message, phone });
