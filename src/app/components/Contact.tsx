    ...
    return (
        <form onSubmit={handleSubmit} className="max-w-screen-lg mx-auto my-32">
            ...
            <div className="relative z-0 w-full mb-5 group">
                ...
                <input type="email" name="email" value={values.email} id="floating_email" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required onChange={handleInputChange}/>
            ...
            <div className="grid">
                <div className="relative z-0 w-full mb-5 group">
                    ...
                    <input type="tel" pattern="(\+44\s?7\d{3}|\(?07\d{3}\)?)\s?\d{3}\s?\d{3}" name="phone" value={values.phone} id="floating_phone" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder="" required onChange={handleInputChange} title="Enter a valid UK phone number"/>
            ...
            <div className="grid">
                <div className="relative z-0 w-full mb-5 group">
                    ...
                    <textarea name="message" value={values.message} id="floating_message" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer min-h-24" placeholder=" " required onChange={handleInputChange}/>
