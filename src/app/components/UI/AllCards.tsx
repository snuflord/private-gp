...
export function Card({article}: {article: any}) {
    ...
    return (
        <Link href={`/articles/${data.slug}`} className="mb-2 md:mb-4 group transition duration-300 border-solid border-2 border-slate-800 dark:border-white dark:bg-slate-800 p-4 w-full min-h-32 md:min-h-56 h-full flex flex-col">
            ...
            {/* <p className="text-xs md:text-base mb-2">{truncatedDescription}</p> */}
